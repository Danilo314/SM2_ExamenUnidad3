...
class _PantallaChatsActivosState extends State<PantallaChatsActivos> {
  // Lista de avatares disponibles en tu carpeta assets/avatars/
  final List<String> avataresDefault = [
    "assets/avatars/cat.png",
    "assets/avatars/dog.png",
    "assets/avatars/bear.png",
    // agrega los demás que tengas
  ];

  // Map que guarda avatar aleatorio fijo para cada usuario
                        ...
                        child: ListTile(
                          leading: CircleAvatar(
                            ...
                            backgroundImage: (fotoPerfil != null &&
                                ...
                                : AssetImage(obtenerAvatar(otherUserId))
                                    as ImageProvider,
                          ),
                          title: Text(
                            nombre,
